...
function Home(props) {
  ...
  const ShortcutLink = (props) => (
    <div className={`${props.className}`} style={props.style}>
      <div
        className={`${
          props.childClass == null ? "bg-gray1" : props.childClass
        } rounded-xl item p-2  w-100 d-flex-column align-items-baseline`}
      >
        <NavLink
          to={{
            pathname: props.link,
        ...
        >
          ...
          <div className="d-flex mb-1 align-items-baseline">
            ...
            <div className="text-white fs-26">{props.count}</div>
          </div>
          {props.children}
        </NavLink>
      </div>
  ...
  const loadData = () => {
    ...
    if (props.result !== null && !hasLoadedPost) {
      let tempPost = props.result.filter(
        (post) =>
          post.rhContentPriorityLevel === 1 &&
    ...
    if (props.resultBlog !== null && !hasLoadedBlog) {
      ...
      let currentPosts = props.resultBlog.filter(
        (post) =>
          post.rhContentPriorityLevel === 1 &&
          Utils.isImageFileUrl(post.rhContentPrincipalLink)
      );
      ...
      let tempBlogWithoutImage = props.resultBlog.filter((blog) =>
      ...
      if (typeof myVar !== "undefined") {
        ...
        console.log(
          "Blogs with image",
          props.resultBlog.filter(
            (blog) => blog.rhContentId !== tempBlogWithoutImage.rhContentId
          )
        );
  ...
  useEffect(() => {
    ...
    if (props.resultBlog === null) props.getAllBlogAction();
  });
        ...
        <div className="container-fluid">
          <div className="row home-slider-container pt-5 pb-5">
                ...
                <div className="row">
                  <div className="col-12" style={{ paddingRight: 0 }}>
                    ...
                    <a
                      target="_blank"
                      rel="noreferrer"
                      href={Constant.applicationRh.taleo.url}
                      className="skiptranslate btn letter-spacing-1 mb-0 pb-0"
                      data-toggle="tooltip"
                      data-placement="bottom"
                      title={t('hrApps.taleo')}
                    >
                  ...
                  <div className="col-12" style={{ paddingRight: 0 }}>
                    ...
                    <a
                      ...
                      title="Description,,,"
                      rel="noreferrer"
                      href={Constant.applicationRh.myInfos.url}
                      className="skiptranslate btn letter-spacing-1 pt-3 mb-0 pb-0"
                      data-toggle="tooltip"
                      data-placement="bottom"
                      title={t('hrApps.myInfos')}
                    >
                      <h5 className="font-weight-bold mb-0">
                  ...
                  <div className="col-12" style={{ paddingRight: 0 }}>
                    ...
                    <a
                      target="_blank"
                      rel="noreferrer"
                      href={checkAppLink(Constant.applicationRh.e_learning.url)}
                      className="skiptranslate btn letter-spacing-1 pt-3 mb-0 pb-0"
                      data-toggle="tooltip"
                      data-placement="bottom"
                      title={t('hrApps.e_learning')}
                    >
                      <h5 className="font-weight-bold mb-0">
                  ...
                  <div className="col-12" style={{ paddingRight: 0 }}>
                    ...
                    <a
                      ...
                      rel="noreferrer"
                      href={checkAppLink(
                        Constant.applicationRh.livretAcueil.url
                      )}
                      data-toggle="tooltip"
                      data-placement="bottom"
                      title={t('hrApps.livretAcueil')}
                      className="skiptranslate btn letter-spacing-1 pt-3 mb-0 pb-0"
                    >
                      <h5 className="font-weight-bold mb-0">
                        {Constant.applicationRh.livretAcueil.title}
                      </h5>
                    </a>
                  </div>
                  <div className="col-12" style={{ paddingRight: 0 }}>
                    ...
                    <a
                      target="_blank"
                      rel="noreferrer"
                      href={checkAppLink(Constant.applicationRh.fusion.url)}
                      className="skiptranslate btn letter-spacing-1 pt-3 mb-0 pb-0"
                      data-toggle="tooltip"
                      data-placement="bottom"
                      title={t('hrApps.fusion')}
                    >
                      <h5 className="font-weight-bold">
                        {Constant.applicationRh.fusion.title}
                      </h5>
                    </a>
                  </div>
                </div>
            ...
            <div className="col-lg-6 col-sm-12 col-md-12 py-2">
              <div className="">
                <h4
                  className="text-capitalize pb-3
                                "
                >
                  {t("common.latest_posts")}
                </h4>
                <div className="row">
                      ...
                      props.result !== null && (
                        <Slider
                          ...
                          slides={props.result
                            ...
                            .sort((a, b) =>
                              moment(a.rhContentDatePublish).isBefore(
                                b.rhContentDatePublish
                              )
                                ? 1
                                : -1
                            )
                          ...
                          renderItem={(post) => (
                            <div className="col">
                              <div className="row no-gutters shadow-sm rounded overflow-hidden flex-md-row mb-4 h-md-250 position-relative bg-white">
                                ...
                                <div className="row news-card bg-white">
                                  <div className="col-md-6 px-0">
                                    {!_.isNil(post.rhContentPrincipalLink) ? (
                                      Utils.isImageFileUrl(
                                        post.rhContentPrincipalLink
                                      ) ? (
                                    ...
                                    <div className="news-feed-text">
                                      ...
                                      <span className="date">
                                        <div className="mb-1 font-weight-medium text-dark text-capitalize h6">
                                          {moment(
                                            post.rhContentDatePublish
                                          ).format("ll")}
                                        </div>
                                      </span>
                                      <span>
                                        <Interweave
                                          content={Utils.removeTag(
                                            Utils.cutString(
                                              post.rhContentDescription,
                                              200
                                            )
                                          )}
                                        />
                  ...
                  <div className="item p-2 bg-primary w-100 rounded-xl d-flex-column align-items-baseline">
                    ...
                    >
                      ...
                      <div className="d-flex mb-1 align-items-baseline">
                        <div className="d-flex flex-grow-1">
                          <div
                            className={"fa-2x pr-2 color-primary text-white"}
                          >
                    ...
                    >
                      ...
                      <div className="d-flex mb-1 align-items-baseline">
                        <div className="d-flex flex-grow-1">
                          <div
                            className={"fa-2x color-primary text-white pr-2"}
                          >
                            <FontAwesomeIcon icon={faFemale} />
                            +
                            <FontAwesomeIcon icon={faMale} />
          ...
          <div className="container">
            <div className="row display-flex">
              {props.loadingBlog && blogsWithoutImage === null ? (
                ...
                blogsWithoutImage !== undefined && (
                  <>
                    <div className="col-xl-12 col-lg-12 col-md-12 hidden-sm hidden-xs block-card block-card-black block-card-full text-align-center post-full-home">
                      <NavLink
                        to={{
                        ...
                        <div className="row">
                          <div
                            ...
                            style={{
                              backgroundImage: `url(${
                                Config.imageFolder +
                                blogsWithoutImage.rhContentPrincipalLink
                              })`,
                            }}
                          ></div>
                          <div className="col-sm-4 bg-dark p-4">
                            <h2>{blogsWithoutImage.rhContentTitle}</h2>
                            <p>
                              <span style={{ color: "#ffffff" }}>
                                <Interweave
                                  content={Utils.removeTag(
                                    Utils.cutString(
                                      blogsWithoutImage.rhContentDescription,
                                      200
                                    )
                                  )}
                                />
                          ...
                          <div className="col-md-4">
                            <div className="card mb-4 shadow-sm">
                              {!_.isNil(blog.rhContentPrincipalLink) ? (
                                ...
                                <img
                                  className="img-fluid img-reponsive"
                                  loading="lazy"
                                  src="https://picsum.photos/800/650"
                                />
                              )}
                              <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                  ...
                                  <small className="text-muted">
                                    {moment(blog.rhContentDateCeated).format(
                                      "lll"
                                    )}
                                  </small>
                                </div>
          ...
          slides={[
            ...
            >
              <h3 className="text-center m-auto">
                <span style={{ color: "#ffffff" }}>
                  L’innovation est essentielle à notre entreprise.{" "}
                </span>
                <br />
...
const mapStateToProps = (state) => ({
  loading: state.getAllPostsRhReducer.loading,
  result: state.getAllPostsRhReducer.result,
  error: state.getAllPostsRhReducer.error,
